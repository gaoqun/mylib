...
public class DiskCacheUtil {
    ...
    public static DiskCacheUtil getDiskCacheUtil(Context context) {
        if (diskCacheUtil == null) {
            synchronized (DiskCacheUtil.class) {
                if (null == diskCacheUtil) {
    ...
    private DiskLruCache generateCache(Context context, File dir, int maxCount) throws IOException {
        ...
        int appVersion = context == null ? DEFAULT_APP_VERSION : AppUtil.getAppVersionCode(context);
